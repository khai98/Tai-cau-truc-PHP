            ...
            <table id="example" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0"
                ...
                <?php foreach ($displayCategories as $displayCategory) : ?>
                    <tr>
                        ...
                        <td> <?php echo $displayCategory['email'] ?></td>
                        <td> <?php echo $displayCategory['brithday'] ?></td>
                        <td> <?php echo $displayCategory['address'] ?></td>
                        <td> <?php echo $displayCategory['phone'] ?></td>
                        ...
                        <td><a href="addnewcaterogy.php">Add New Category</a></td>
                    </tr>
                <?php endforeach; ?>
                </thead>
            </table>
